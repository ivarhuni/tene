...
function App() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8 overflow-hidden">
      ...
      <p
        className="text-sunshine-300 text-sm md:text-lg font-semibold mb-8 md:mb-10 tracking-widest uppercase"
      ...
      {/* Destination date */}
      <p
        className="mt-6 text-white/70 text-xs md:text-sm font-medium tracking-widest uppercase"
